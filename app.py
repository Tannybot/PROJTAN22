...
def add_bg_from_local(image_file):
    try:
        with open(image_file, "rb") as f:
            ...
            h1, h2, h3, h4, h5, h6, .css-10trblm, .css-1544g2n, .stMarkdown h1, .stMarkdown h2, .stMarkdown h3, .stMarkdown h4, .stMarkdown h5, .stMarkdown h6 {{
                color: #FFFFFF !important;
                font-weight: 600;
            }}
            .stButton button {{
...
# Streamlit UI setup
st.set_page_config(page_title="Event Scheduler and Registration", layout="centered")

# Custom title with styling
st.markdown('<div class="main-title"><h1>Welcome to the Event Scheduler and Registration</h1></div>', unsafe_allow_html=True)
